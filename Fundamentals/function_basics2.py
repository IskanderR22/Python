...
# Countdown Countdown - Create a function that accepts a number as an input. 
...
print(first_plus_length(new_list))



# Values Greater than Second - Write a function that accepts a list and creates a 
# new list containing only the values from the original list that are greater than its 2nd value. 
