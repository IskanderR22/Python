...
-- Use the COUNT function & GROUP BY
...
JOIN countries
ON cities.country_id = countries.id
WHERE cities.population > 500000 AND cities.country_id = 136 -- We can have OR, AND in a WHERE line
...
SELECT countries.region, COUNT(countries.id) AS country_amount
FROM countries
GROUP BY countries.region
ORDER BY country_amount DESC; 
